...
class Config:
    def __init__(self):
        ...
        self.last_model_path = './model/weights_1010.hdf5'
        self.model_save_path = './model/weights_1011.hdf5'

        # params add by me
        self.data_dir = '.data/'
        self.num_epochs = 100

        self.kitti_simple_label_file = './dataset/kitti_vehicle_label_local.txt'
