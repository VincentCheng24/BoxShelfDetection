...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
    '''to generate and label the proposals '''
    ...
    while True:
        ...
        for img_data in all_img_data:
            try:
                ...
                # get image dimensions for resizing: height 600, aspect ratio: keeps
                ...
                # generate the proposals and the labels for them as the GT
                except:
                    continue
